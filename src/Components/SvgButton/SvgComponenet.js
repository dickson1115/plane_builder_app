...
function SvgComponenet(name) {
    const [ svgElements, setSvgElements ] = useState(
        {
            engine_front: <svg xmlns="http://www.w3.org/2000/svg" name="engine_front" viewBox="0 0 240 240">
            ...
            wheel_front: < svg xmlns="http://www.w3.org/2000/svg" name="wheel_front" viewBox="0 0 240 240" >
            ...
            fuselage_front: < svg xmlns="http://www.w3.org/2000/svg" name="fuselage_front" viewBox="0 0 240 240" >
                <defs />
            ...
            wing_front: < svg xmlns="http://www.w3.org/2000/svg" name="wing_front" viewBox="0 0 240 30" height_multiplier="2" width_multiplier="2" >
                <defs />
            ...
            strut: < svg xmlns="http://www.w3.org/2000/svg" name="strut" viewBox="0 0 30 240" height_multiplier="2" width_multiplier="2" >
                <defs />
