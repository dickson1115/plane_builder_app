...
function BuilderCanvas() {
  return (
    <div className={styles.builderCanvas}>
      ...
      {/* Engine */}
      <InteractableItem>
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 240 240">
      ...
      {/* fuselage */}
      <InteractableItem>
        <svg xmlns="http://www.w3.org/2000/svg" height="80" width="80" viewBox="0 0 240 240">
          <defs />
      ...
      {/* Wing */}
      <InteractableItem>
        <svg xmlns="http://www.w3.org/2000/svg" width="240" height="80" viewBox="0 0 240 30">
          <defs />
      ...
      {/* Strut */}
      <InteractableItem>
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="100px" viewBox="0 0 30 240">
          <defs />
